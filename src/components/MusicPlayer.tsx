...
export default function MusicPlayer() {
  ...
  return (
    <>
      ...
      <motion.div
        className="fixed bottom-24 right-3 z-50 flex flex-col items-end gap-3 sm:bottom-6 sm:right-6 sm:gap-4 md:bottom-6"
      ...
      >
        <AnimatePresence>
          {isOpen ? (
            <motion.div
              ...
              className="glass-card w-[min(22rem,calc(100vw-1.5rem))] rounded-3xl border border-white/20 p-4 shadow-2xl"
            >
              ...
              <div className="mt-6 rounded-2xl border border-white/10 bg-black/20 p-4">
                <div className="mb-3 flex items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="inline-flex shrink-0 items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-xs font-medium text-white/80 transition-colors hover:bg-white/10"
                  >
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                  ...
                  <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <button
                      type="button"
                      onClick={playRandomTrack}
                      className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-white px-4 py-2 text-sm font-semibold text-black transition-transform hover:scale-[1.02] sm:w-auto"
                    >
        ...
        {!isOpen ? (
          <motion.button
            ...
            className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-orange-500 to-pink-500 text-white shadow-lg shadow-orange-500/30 sm:h-14 sm:w-14"
          >
            {isPlaying ? (
